...
CREATE TABLE IF NOT EXISTS builders_risk_insurees(
  ...
  mailing_address_city varchar(80),
  mailing_address_zip varchar(10) NOT NULL,
  ext_scaffolding boolean NOT NULL,
  ext_temp_structures boolean NOT NULL,
  ext_pollutant_cleanup boolean NOT NULL,
  ext_debris_removal boolean NOT NULL,
)